  ...
  return (
    <div className="min-h-screen pb-8" style={{ background: '#1a1a1a' }}>
      <div className="px-6 pt-12 pb-4 flex items-center gap-4">
        ...
        <h1 className="text-xl font-semibold" style={{ color: '#f5f0e8' }}>ניהול הדרכות</h1>
      </div>
      ...
      <div className="px-6 flex flex-col items-center justify-center py-12 gap-3">
        ...
        <p className="text-sm" style={{ color: '#a89880' }}>ניהול הדרכות — בקרוב</p>
        <p className="text-xs text-center" style={{ color: '#555' }}>כרגע ניתן להוסיף הדרכות ישירות דרך Supabase</p>
      </div>
    </div>
  )
}
